...
import Car from "~/components/Quest/Car";
                ...
                <div className="w-full md:w-full xl:w-9/12 mx-auto flex items-center justify-center">
                    ...
                    <div className=" w-full">
                        <div className="  uppercase text-center leading-none md:top-14 md:left-16 lg:top:6 lg:left-10 xl:top-16 xl:left-16 2xl:top-14 2xl:left-64">
                            <div className="font-trash font-bold text-[4.4vw] lg:text-[3vw] 2xl:text-[2.8vw]">CARBONABLE ODYSSEY</div>
                            <div className="font-americana font-thin text-[3.8vw] lg:text-[2.6vw] 2xl:text-[2.2vw]">ANTI GREENWASHING </div>
